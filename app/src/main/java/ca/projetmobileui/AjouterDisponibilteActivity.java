    ...
    private void liaison() {
        ...
        btnCreateDispo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String date = edtDateCourier.getText().toString();
                ...
                boolean dateIsValid =
                        Utils.checkRegexDateHeure(date);
                ...
                if (isSaveInfo) {
                    saveDisponibilite(firstName, lastName, adress, phoneNumber, date );
                }
            }
        });
    }

    private void saveDisponibilite(String firstName, String lastName, String adress, String phoneNumber, String date) {
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://10.0.2.2:8080/")
                .addConverterFactory(GsonConverterFactory.create())
                .build();
        RetrofitApi retrofitApi = retrofit.create(RetrofitApi.class);
        Courier courier = new Courier(firstName, lastName, adress, phoneNumber, date);
